...
export const Home = () => {
  return (
    <>
      ...
      <S.MainContainer>
        <CatalogCard
          productImageUrl="../../assets/expresso.svg"
        ...
        />
        <CatalogCard
          productImageUrl="../../assets/expresso.png"
          coffeType={['Tradicional']}
        ...
        />
        <CatalogCard
          productImageUrl="../../assets/cremoso.png"
          coffeType={['Tradicional']}
        ...
        />
        <CatalogCard
          productImageUrl="../../assets/express-gelado.png"
        ...
        />
        <CatalogCard
          productImageUrl="../../assets/latte.png"
